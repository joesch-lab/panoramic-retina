function F = Gaussian_Mixture_Rot_oppositesign(weightx,data_structure)
...
%         x0rot1 = fixparam1(2)*cos(fixparam1(6)) - fixparam1(3)*sin(fixparam1(6));
%         y0rot1 = fixparam1(2)*sin(fixparam1(6)) + fixparam1(3)*cos(fixparam1(6));
%         F1 = fixparam1(1)*exp(   -((xdatarot1(:,:,1)-x0rot1).^2/(2*fixparam1(4)^2) + (xdatarot1(:,:,2)-y0rot1).^2/(2*fixparam1(5)^2) )    );
        F1 = fixparam1(1)*exp(   -((xdatarot1(:,:,1)).^2/(2*fixparam1(4)^2) + (xdatarot1(:,:,2)).^2/(2*fixparam1(5)^2) )    );
    else
        F1=zeros(size(xdataor,1),size(xdataor,2));
    end
...
%         x0rot2 = fixparam2(2)*cos(fixparam2(6)) - fixparam2(3)*sin(fixparam2(6));
%         y0rot2 = fixparam2(2)*sin(fixparam2(6)) + fixparam2(3)*cos(fixparam2(6));
%         F2 = fixparam2(1)*exp(   -((xdatarot2(:,:,1)-x0rot2).^2/(2*fixparam2(4)^2) + (xdatarot2(:,:,2)-y0rot2).^2/(2*fixparam2(5)^2) )    );
        F2 = fixparam2(1)*exp(   -((xdatarot2(:,:,1)).^2/(2*fixparam2(4)^2) + (xdatarot2(:,:,2)).^2/(2*fixparam2(5)^2) )    );
    else
        F2=zeros(size(xdataor,1),size(xdataor,2));
    end
