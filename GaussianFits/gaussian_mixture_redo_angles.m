function RFprops = gaussian_mixture_redo_angles(RFprops, sizes)
%Lightweight version, that doesnt need actual RFs, only computes properties
%feom the gaussian fits
...
[nrow,ncol, nhist, ncl] = deal(sizes(1), sizes(2), sizes(3), sizes(4));
